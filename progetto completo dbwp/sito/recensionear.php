...
<h2>Scrivi la tua recensione di <?php 
  $q = "SELECT Nome from Album_Artista where ID_Album = '$id';";
  $result = $conn->query($q);
 ...
 <form action = "recensionear.inc.php?id=<?php echo $id ?>" method = "post">
...
<form action = "updaterecensionear.inc.php?id=<?php echo $id ?>" method = "post">
 <input type ="text" name = "titolo" placeholder ="Titolo recensione...">
 <input type ="text" name = "corpo" placeholder ="Corpo...">
 <input type ="number" name = "voto" placeholder ="Voto...">
...
if (isset($_GET["error"])) {
     if($_GET["error"] == "votovuoto"){
      ...
      echo "<p>Hai gia una recensione per quel album! Puoi aggiornala sotto</p>";
     }
